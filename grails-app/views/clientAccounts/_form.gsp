...
<div class="form-group">
    ...
    <div class="col-md-6 col-sm-6 col-xs-12">
        <input type="number" id="number" name="number" value="${account.number}" required="required" class="form-control col-md-7 col-xs-12">
    </div>
</div>
%{--<div class="form-group">--}%
    ...
    %{--<div class="col-md-9 col-sm-9 col-xs-12">--}%
        %{--<div class="">--}%
            %{--<label>--}%
                %{--<g:checkBox name="keyRequired" class="js-switch" checked="${account?.keyRequired}" />--}%
            %{--</label>--}%
        %{--</div>--}%
    %{--</div>--}%
%{--</div>--}%
