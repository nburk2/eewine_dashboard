...
<head>
    ...
    <g:set var="entityName" value="${message(code: 'clientaccount.label', default: 'ClientAccounts')}" />
        ...
        <div class="row">
            <div class="col-xs-12">
                <div class="x_panel">
                    ...
                    <g:form id="demo-form2" url="[resource:account, action:'edit']" class="form-horizontal form-label-left">
