...
<div class="form-group">
    ...
    <div class="col-md-6 col-sm-6 col-xs-12">
        <g:datePicker id="medCardExpDate" name="medCardExpDate" precision="day" relativeYears="[-5..10]" value="${driver?.medCardExpDate ?: "none"}"/>
    </div>
</div>
<div class="form-group">
    <label for="driversLicenseExpDate" class="control-label col-md-3 col-sm-3 col-xs-12">Drivers License exp.</label>
    <div class="col-md-6 col-sm-6 col-xs-12">
        <g:datePicker name="driversLicenseExpDate" precision="day" relativeYears="[-5..10]" value="${driver?.driversLicenseExpDate ?: "none"}"/>
    </div>
</div>
<div class="form-group">
    ...
    %{--</div>--}%
    <div class="col-md-6 col-sm-6 col-xs-12">
        <g:datePicker name="hazmatExpDate" precision="day" relativeYears="[-5..10]" value="${driver?.hazmatExpDate ?: "none"}"/>
    </div>
</div>
