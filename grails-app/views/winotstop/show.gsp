...
<head>
    ...
    <g:set var="entityName" value="${message(code: 'winotstop.label', default: 'Winotstop')}" />
            ...
            <div class="col-xs-12">
                <div class="x_panel">
                    <div class="inner_nav_title">
                        <p class="lead">Show Wi-Not-Stop Entry</p>
                        <div class="table-responsive">
                            <table class="table">
                                <tbody>
                                <tr>
                                    <th style="width:50%">Name:</th>
                                    <td>${winotstop.name}</td>
                                </tr>
                                <tr>
                                    <th>Value:</th>
                                    <td>${winotstop.value}</td>
                                </tr>
                                </tbody>
                            </table>
                        </div>
                    </div>
                    <g:form id="demo-form2" url="[resource:winotstop, action:'edit']" class="form-horizontal form-label-left">
