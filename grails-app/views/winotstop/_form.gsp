<div class="form-group">
    ...
    <div class="col-md-6 col-sm-6 col-xs-12">
        <g:if test="${winotstop?.hasErrors()}">
            <div class="alert alert-danger">
                <g:renderErrors bean="${winotstop}" as="list" field="name"/>
            </div>
        </g:if>
        <input type="text" id="name" name="name" value="${winotstop?.name}" required="required" class="form-control col-md-7 col-xs-12">
    </div>
...
<div class="form-group">
    ...
    <div class="col-md-6 col-sm-6 col-xs-12">
        <input type="text" id="value" name="value" value="${winotstop.value}" required="required" class="form-control col-md-7 col-xs-12">
    </div>
</div>
