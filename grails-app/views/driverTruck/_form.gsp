...
<div class="form-group">
    <label class="control-label col-md-3 col-sm-3 col-xs-12">Driver</label>
    <div class="col-md-9 col-sm-9 col-xs-12">
        <g:select name="truck" from="${dashboard.data.Truck.list()}" class="select2_single form-control" optionKey="id" value="${driverTruck?.truck?.id}" tabindex="-1"/>
    </div>
</div>
<div class="form-group">
...
<div class="form-group">
    <label class="control-label col-md-3 col-sm-3 col-xs-12">Driver working</label>
    <div class="col-md-9 col-sm-9 col-xs-12">
        <div class="">
            <label>
                <g:checkBox name="off" class="js-switch" value="${driverTruck.off}" />
            </label>
        </div>
    </div>
</div>
