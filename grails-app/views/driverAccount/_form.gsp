<div class="form-group">
    ...
    <div class="col-md-9 col-sm-9 col-xs-12">
        <g:select name="driver" from="${dashboard.data.Driver.list()}" class="select2_single form-control" optionKey="id" value="${driverAccount?.driver?.id}" tabindex="-1"/>
    </div>
</div>
<div class="form-group">
    <label class="control-label col-md-3 col-sm-3 col-xs-12">Accounts</label>
    <div class="col-md-9 col-sm-9 col-xs-12">
        <g:select name="accounts" from="${dashboard.data.Account.list()}" noSelection="['':'']" class="select2_single form-control" optionKey="id" value="${driverAccount?.accounts?.id}" tabindex="-1" multiple="true"/>
    </div>
</div>
