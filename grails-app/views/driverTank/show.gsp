                    ...
                    <div class="col-xs-12">
                        <div class="x_panel">
                            <div class="inner_nav_title">
                                <p class="lead">Show Driver Tanks</p>
                                <div class="table-responsive">
                                    <table class="table">
                                        <tbody>
                                        <tr>
                                            <th style="width:50%">Driver:</th>
                                            <td>${driverTank.driver}</td>
                                        </tr>
                                        <tr>
                                            <th>accounts:</th>
                                            <td>${driverTank.tanks}</td>
                                        </tr>
                                        </tbody>
                                    </table>
                                </div>
                            </div>
                            <g:form id="demo-form2" url="[resource:driverTank, action:'edit']" class="form-horizontal form-label-left">
